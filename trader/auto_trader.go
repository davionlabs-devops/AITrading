...
type AutoTraderConfig struct {
	...
	// APEX配置
	ApexAccountID   string // APEX Account ID
	ApexAPIKey      string // APEX API Key
	ApexAPISecret   string // APEX API Secret
	ApexPassphrase  string // APEX API Key Passphrase
	ApexOmniKeySeed string // APEX Omni Key Seed (可选)
...
func NewAutoTrader(config AutoTraderConfig, database interface{}, userID string) (*AutoTrader, error) {
	...
	case "apex":
		...
		trader, err = NewApexTrader(config.ApexAccountID, config.ApexAPIKey, config.ApexAPISecret, config.ApexPassphrase, config.ApexOmniKeySeed, false)
		if err != nil {
