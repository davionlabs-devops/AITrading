...
export const translations = {
  en: {
    ...
    // Footer
    footerTitle: 'APEXAI - AI Trading System',
    ...
    heroDescription:
      'APEXAI is the future standard for AI trading — an open, community-driven agentic trading OS. Supporting Binance, Aster DEX and other exchanges, self-hosted, multi-agent competition, let AI automatically make decisions, execute and optimize trades for you.',
    poweredBy:
    ...
    startWithCrypto:
      'Starting with crypto markets, expanding to TradFi. APEXAI is the infrastructure of AgentFi.',
    getStartedNow: 'Get Started Now',
    viewSourceCode: 'View Source Code',

    // Features Section
    coreFeatures: 'Core Features',
    whyChooseNofx: 'Why Choose APEXAI?',
    openCommunityDriven:
    ...
    // About Section
    aboutNofx: 'About APEXAI',
    whatIsNofx: 'What is APEXAI?',
    nofxNotAnotherBot:
      "APEXAI is not another trading bot, but the 'Linux' of AI trading —",
    nofxDescription1:
    ...
    howToStart: 'How to Get Started with APEXAI',
    fourSimpleSteps:
    ...
    riskWarningText:
      'Dev branch is unstable, do not use funds you cannot afford to lose. APEXAI is non-custodial, no official strategies. Trading involves risks, invest carefully.',
    ...
    // Login Modal
    accessNofxPlatform: 'Access APEXAI Platform',
    loginRegisterPrompt:
    ...
    faqSubtitle: 'Find answers to common questions about APEXAI',
    ...
    faqWhatIsAPEXAI: 'What is APEXAI?',
    faqWhatIsAPEXAIAnswer:
      'APEXAI is an AI-powered cryptocurrency trading bot that uses large language models (LLMs) to make trading decisions on futures markets.',
    ...
    faqIsProfitable: 'Is APEXAI profitable?',
    ...
    faqMultipleTradersAnswer:
      'Yes! APEXAI supports running multiple traders with different configurations, AI models, and trading strategies.',
    ...
    faqNeedCodingAnswer:
      'No! APEXAI has a web UI for all configuration. However, basic command line knowledge helps with setup and troubleshooting.',
    ...
    faqUseSubaccountAnswer:
      'Recommended: Yes, use a subaccount dedicated to APEXAI for better risk isolation. However, note that some subaccounts have restrictions (e.g., 5x max leverage on Binance).',
    ...
    faqHighFeesAnswer:
      'APEXAI default 3-minute scan interval can cause frequent trading. Solutions: Increase decision interval to 5-10 minutes; Optimize system prompt to reduce overtrading; Adjust leverage to reduce position sizes.',
    ...
    faqPortInUseAnswer:
      'Check what\'s using port 8080 with "lsof -i :8080" and change the port in your .env file with APEXAI_BACKEND_PORT=8081.',
    ...
    faqDatabaseLockedAnswer:
      'Stop all APEXAI processes with "docker compose down" or "pkill nofx", then restart with "docker compose up -d".',
    ...
    faqAiLearningAnswer:
      'Yes, to some extent. APEXAI provides historical performance feedback in each decision prompt, allowing the AI to adjust its strategy.',
  ...
  zh: {
    ...
    heroTitle2: 'Write the Trade.',
    heroDescription:
      'APEXAI 是 AI 交易的未来标准——一个开放、社区驱动的代理式交易操作系统。支持 Binance、Aster DEX 等交易所，自托管、多代理竞争，让 AI 为你自动决策、执行和优化交易。',
    poweredBy: '由 Aster DEX 和 Binance 提供支持，Amber.ac 战略投资。',

    // Landing Page CTA
    readyToDefine: '准备好定义 AI 交易的未来吗？',
    startWithCrypto:
      '从加密市场起步，扩展到 TradFi。APEXAI 是 AgentFi 的基础架构。',
    getStartedNow: '立即开始',
    viewSourceCode: '查看源码',

    // Features Section
    coreFeatures: '核心功能',
    whyChooseNofx: '为什么选择 APEXAI？',
    ...
    // About Section
    aboutNofx: '关于 APEXAI',
    whatIsNofx: '什么是 APEXAI？',
    nofxNotAnotherBot: "APEXAI 不是另一个交易机器人，而是 AI 交易的 'Linux' ——",
    ...
    riskWarningText:
      'dev 分支不稳定，勿用无法承受损失的资金。APEXAI 非托管，无官方策略。交易有风险，投资需谨慎。',
    ...
    // Login Modal
    accessNofxPlatform: '访问 APEXAI 平台',
    ...
    // FAQ Page
    faqTitle: '常见问题',
    faqSubtitle: '查找关于 APEXAI 的常见问题解答',
    ...
    faqNeedCodingAnswer:
      '不需要！APEXAI 有 Web 界面进行所有配置。但基础的命令行知识有助于安装和故障排查。',
    ...
    faqUseSubaccountAnswer:
      '推荐：是的，使用专门的子账户运行 APEXAI 可以更好地隔离风险。但请注意，某些子账户有限制（例如币安子账户最高 5 倍杠杆）。',
    ...
    faqHighFees: '交易手续费太高',
    faqHighFeesAnswer:
      'APEXAI 默认 3 分钟扫描间隔会导致频繁交易。解决方案：将决策间隔增加到 5-10 分钟；优化系统提示词减少过度交易；调整杠杆降低仓位大小。',
    ...
    faqPortInUseAnswer:
      '使用 "lsof -i :8080" 查看占用端口的进程，在 .env 中修改端口：APEXAI_BACKEND_PORT=8081。',
    ...
    faqDatabaseLockedAnswer:
      '使用 "docker compose down" 或 "pkill nofx" 停止所有 APEXAI 进程，然后使用 "docker compose up -d" 重启。',
    ...
    faqAiLearningAnswer:
      '会的，在一定程度上。APEXAI 在每次决策提示中提供历史表现反馈，允许 AI 调整策略。',
