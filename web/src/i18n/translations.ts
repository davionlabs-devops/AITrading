...
export const translations = {
  en: {
    ...
    // Footer
    footerTitle: 'APEX AI 交易策略工具 - AI Trading System',
    ...
    heroDescription:
      'APEX AI 交易策略工具 is the future standard for AI trading — an open, community-driven agentic trading OS. Supporting Binance, Aster DEX and other exchanges, self-hosted, multi-agent competition, let AI automatically make decisions, execute and optimize trades for you.',
    poweredBy:
    ...
    startWithCrypto:
      'Starting with crypto markets, expanding to TradFi. APEX AI 交易策略工具 is the infrastructure of AgentFi.',
    getStartedNow: 'Get Started Now',
    viewSourceCode: 'View Source Code',

    // Features Section
    coreFeatures: 'Core Features',
    whyChooseNofx: 'Why Choose APEX AI 交易策略工具?',
    openCommunityDriven:
    ...
    // About Section
    aboutNofx: 'About APEX AI 交易策略工具',
    whatIsNofx: 'What is APEX AI 交易策略工具?',
    nofxNotAnotherBot:
      "APEX AI 交易策略工具 is not another trading bot, but the 'Linux' of AI trading —",
    nofxDescription1:
    ...
    howToStart: 'How to Get Started with APEX AI 交易策略工具',
    fourSimpleSteps:
    ...
    riskWarningText:
      'Dev branch is unstable, do not use funds you cannot afford to lose. APEX AI 交易策略工具 is non-custodial, no official strategies. Trading involves risks, invest carefully.',
    ...
    // Login Modal
    accessNofxPlatform: 'Access APEX AI 交易策略工具 Platform',
    loginRegisterPrompt:
  ...
  zh: {
    ...
    // Footer
    footerTitle: 'APEX AI 交易策略工具 - AI交易系统',
    ...
    heroTitle2: 'Write the Trade.',
    heroDescription:
      'APEX AI 交易策略工具 是 AI 交易的未来标准——一个开放、社区驱动的代理式交易操作系统。支持 Binance、Aster DEX 等交易所，自托管、多代理竞争，让 AI 为你自动决策、执行和优化交易。',
    poweredBy: '由 Aster DEX 和 Binance 提供支持，Amber.ac 战略投资。',

    // Landing Page CTA
    readyToDefine: '准备好定义 AI 交易的未来吗？',
    startWithCrypto:
      '从加密市场起步，扩展到 TradFi。APEX AI 交易策略工具 是 AgentFi 的基础架构。',
    getStartedNow: '立即开始',
    viewSourceCode: '查看源码',

    // Features Section
    coreFeatures: '核心功能',
    whyChooseNofx: '为什么选择 APEX AI 交易策略工具？',
    ...
    // About Section
    aboutNofx: '关于 APEX AI 交易策略工具',
    whatIsNofx: '什么是 APEX AI 交易策略工具？',
    nofxNotAnotherBot: "APEX AI 交易策略工具 不是另一个交易机器人，而是 AI 交易的 'Linux' ——",
    ...
    // How It Works Section
    howToStart: '如何开始使用 APEX AI 交易策略工具',
    ...
    riskWarningText:
      'dev 分支不稳定，勿用无法承受损失的资金。APEX AI 交易策略工具 非托管，无官方策略。交易有风险，投资需谨慎。',
    ...
    // Login Modal
    accessNofxPlatform: '访问 APEX AI 交易策略工具 平台',
